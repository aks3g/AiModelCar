...
#define I2C_INVALID_MODE				(-2)
#define I2C_INVALID_CLOCK				(-3)
#define I2C_MODULE_IS_NOT_MASTER_MODE	(-4)
#define I2C_NOT_IMPLEMENTED				(-5)
#define I2C_BUFFER_IS_NULL_PTR			(-6)

#define I2C_INVALUID_ARGS				(-7)
#define I2C_BUS_ERROR					(-8)
#define I2C_IS_IN_USED					(-9)
